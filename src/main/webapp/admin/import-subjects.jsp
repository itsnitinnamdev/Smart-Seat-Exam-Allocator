...
<head>
    ...
    <title>Import Subjects | Smart-Seat Admin Dashboard</title>
    ...
    <div class="main-content">
        ...
        <div class="top-nav animate__animated animate__fadeInDown">
            <div class="page-title">
                ...
                <p>Bulk upload subject data for different branches and semesters</p>
            </div>
        ...
        <div class="form-container animate__animated animate__fadeInUp">
            ...
            <div class="form-header">
                <h2>Import Subject Data</h2>
                <p>Upload CSV file containing subject information for examination allocation</p>
            </div>
            ...
            <div class="csv-info-card">
                ...
                <div style="margin-top: 15px; font-size: 14px; color: var(--medium-gray);">
                    ...
                    <a href="../downloads/subject_template.csv" style="color: var(--primary-blue); font-weight: 600; text-decoration: none;">
            ...
            <!-- Upload Form -->
            <form action="../ImportSubjectsServlet" method="POST" enctype="multipart/form-data" id="uploadForm">
                <!-- Drop Zone -->
                <div class="drop-zone" id="dropZone">
                    ...
                    <input type="file" name="subjectFile" id="fileInput" accept=".csv" style="display: none;">
                ...
                <button type="submit" class="btn-submit" id="submitButton" disabled>
                    ...
                    <span id="submitText">Start Importing Subjects</span>
